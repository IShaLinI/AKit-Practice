...
public class CommandFactory {
  ...
  public Command changeGamePiece(GamePiece gamePiece) {
    return Commands.parallel(
        elevator.changeGamePiece(gamePiece), intake.changeGamePiece(gamePiece));
  }

  public Command changeSetpoint(ScoringSetpoint setpoint) {
    return Commands.parallel(elevator.changeSetpoint(setpoint), intake.changeSetpoint(setpoint));
  }
}
